...
USER Function SA1_MVC(xRotAuto,nOpcAuto)
	...
	If xRotAuto == Nil
		...
		DEFINE FWMBROWSE oMBrowse ALIAS "SA1" DESCRIPTION "Cadastro de Clientes"	ACTIVATE FWMBROWSE oMBrowse
...
Static Function ViewDef()
	...
	Local oView
	Local oModel := FWLoadModel("SA1_MVC")
