...
Static Function MenuDef()
	...
	ADD OPTION a_Rotina TITLE '&Visualizar' ACTION 'VIEWDEF.TDPA002' OPERATION 2 ACCESS 0
	ADD OPTION a_Rotina TITLE '&Incluir'    ACTION 'VIEWDEF.TDPA002' OPERATION 3 ACCESS 0
	ADD OPTION a_Rotina TITLE '&Alterar'    ACTION 'VIEWDEF.TDPA002' OPERATION 4 ACCESS 0
	ADD OPTION a_Rotina TITLE '&Excluir'    ACTION 'VIEWDEF.TDPA002' OPERATION 5 ACCESS 0
	ADD OPTION a_Rotina TITLE 'Im&primir'   ACTION 'VIEWDEF.TDPA002' OPERATION 8 ACCESS 0
	ADD OPTION a_Rotina TITLE '&Copiar'     ACTION 'VIEWDEF.TDPA002' OPERATION 9 ACCESS 0
	
Return a_Rotina

Static Function ModelDef()
	
	Local oModel	:= MPFormModel():New('TDPA002M')
	Local oStruZA1	:= FWFormStruct( 1, 'ZA1' )
	Local oStruZA2	:= FWFormStruct( 1, 'ZA2' )
	
	oModel:AddFields('ZA1MASTER',/*cOwner*/,oStruZA1)
	oModel:AddGrid('ZA2GRID','ZA1MASTER',oStruZA2,/*bLinePre*/,/*bLinePost*/ {|oModel| f_TDP002POS( oModel ) },/*bPre*/,/*bPos*/,/*bLoad*/)
...
Static Function ViewDef()
	...
	Local oModel	:= FWLoadModel('TDPA002')
