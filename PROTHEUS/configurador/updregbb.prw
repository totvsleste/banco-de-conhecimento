...
/*/
//--------------------------------------------------------------------
User Function UPDREGBB( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDREGBB" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDREGBB" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	100																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs Retorno'															, ; //X3_TITULO
	'Obs Retorno'															, ; //X3_TITSPA
	'Obs Retorno'															, ; //X3_TITENG
	''																		, ; //X3_DESCRIC
	''																		, ; //X3_DESCSPA
	''																		, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDREGBB" ) ) ) ;
