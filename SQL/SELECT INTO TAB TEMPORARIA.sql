 Select * Into #TMPSE5 From SE5990 E5 Where E5_DATA Between '20171001' and '20171031' AND E5_RECPAG = 'P' AND E5_MOTBX IN ('DEB', 'NOR') AND
 NOT EXISTS (SELECT E5_NUMERO FROM SE5990 SE5
 	WHERE SE5.E5_FILIAL=E5.E5_FILIAL
 	AND SE5.D_E_L_E_T_ = ' '
